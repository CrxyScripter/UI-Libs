...
do
    pcall(function()
        local CoreVen = game:GetService("CoreGui"):FindFirstChild("Venyx")
        CoreVen:Destroy()
    end)
...
do
	...
	function section:updateSlider(slider, title, value, min, max, lvalue)
		...
		local mouseSlider = mouse.X
		local percent = (mouseSlider - bar.AbsolutePosition.X) / bar.AbsoluteSize.X
